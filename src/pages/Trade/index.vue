...
export default {
  ...
  methods: {
    ...
    async submit() {
      ...
      let data = {
        consignee: this.selectedAddress.consignee, //最终收件人的名字
        consigneeTel: this.selectedAddress.phoneNum, //最终收件人的手机号
        deliveryAddress: this.selectedAddress.fullAddress, //收件人的地址
